    ...
    */
    ...
    'connections' => [
        ...
        'super_admin' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_SUPER_ADMIN', '127.0.0.1'),
            'port' => env('DB_PORT_SUPER_ADMIN', '3306'),
            'database' => env('DB_DATABASE_SUPER_ADMIN', 'forge'),
            'username' => env('DB_USERNAME_SUPER_ADMIN', 'forge'),
            'password' => env('DB_PASSWORD_SUPER_ADMIN', ''),
            'unix_socket' => env('DB_SOCKET_SUPER_ADMIN', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
