    ...
    <div class="col-lg-12 pt-3">
        <h6>
            <a href="/">Home </a><i class="fa-solid fa-angle-right"></i><a
                href="singlekoleksi.html">Skripsi</a>
        </h6>
        <hr class="mt-0">
    </div>
    <div class="row">
        <div class="col-lg-9 order-2 order-lg-first">
            ...
            <div class="d flex mb-5">
                <h6 class="sidebar-col"><span><i class="fa-solid fa-square-poll-horizontal"></i></span> Skripsi</h6>
            ...
            <div class="cardfilter" style="border: 2px solid rgba(0, 0, 0, 0.185);">
                <div class="card-body">
                    ...
                    <div class="form-group mb-1">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="prodi_ilmu_komputer" value="51">
                            <label class="form-check-label" for="s2_prodi_ilmu_komputer"> S2 Sains Data dan Kecerdasan
                                Buatan</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="prodi_teknologi_informasi" value="52">
