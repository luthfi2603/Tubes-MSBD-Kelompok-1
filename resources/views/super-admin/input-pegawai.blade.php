        ...
        <div class="col-lg-6">
            <div class="inputan-form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control custom-form" id="username-pegawai" placeholder="Input Username Pegawai">
                </div>


                <div class="mb-3">
                    <label for="email-pegawai" class="form-label">Email</label>
                    <input type="email" class="form-control custom-form" id="email-pegawai" placeholder="Input Email Pegawai">
                </div>
        ...
        <div class="col-lg-6">
            <div class="inputan-form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control custom-form" id="nama-pegawai" placeholder="Input Nama Pegawai">
                </div>
