...
<div class="container">
    <div class="col-lg-12 pt-3">
        <h6><a href="/">Home</a><i class="fa-solid fa-angle-right ms-2"></i><span>Prodi</span><i class="fa-solid fa-angle-right ms-2"></i><a href="{{ route('prodi', $prodiParam) }}">{{ $prodi }}</a></h6>
        <hr class="mt-0">
    </div>
    <div class="row">
