...
<div class="container">
    <div class="col-lg-12 pt-3">
        <h6>
        <a href="index.html">Home </a><i class="fa-solid fa-angle-right"></i><a href="singleprodi.html">S1 Ilmu Komputer</a>
        </h6>
        <hr class="mt-0">
    </div>
    <div class="row">
                <div class="col-lg-9 order-2 order-lg-first">
                    ...
                    <div class="d flex mb-5">
                            <h6 class="sidebar-col"><span><i class="fa-solid fa-building-columns"></i></span> S1 Ilmu Komputer</h6>
                        ...
                        <div class="card mt-0" style="max-width: 100%;">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                <h5 class="card-title textit"><a href="detailsearch.html">Pengaruh Sayur Kangkung Terhadap Senyum Kambing</a></h5>
                                <p class="text-muted"><small class="text-body-secondary">Tambunan, Ivan (2023)</small></p>
                                <p class="card-text text">Sayur kangkung adalah makanan kegemaran kambing yang dapat menimbulkan rasa kesenangan seperti munculnya senyuman. Hal ini didasarkan.</p>
                                </div>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="cardfilter" style="border: 2px solid rgba(0, 0, 0, 0.185);">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="jenis_disertasi" value="disertasi">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="jenis_karya_tulis_ilmiah" value="karya_tulis_ilmiah">
                                    <label class="form-check-label" for="jenis_karya_tulis_ilmiah">Karya Tulis Ilmiah</label>
                                </div>
                            </div>
