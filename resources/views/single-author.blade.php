...
<div class="container">
    <div class="col-lg-12 pt-3">
        <h6>
        <a href="index.html">Home </a><i class="fa-solid fa-angle-right"></i><a href="singleauthor.html">Ivan Tambunan</a>
        </h6>
        <hr class="mt-0">
    </div>
    <div class="row">
                <div class="col-lg-9 order-2 order-lg-first">
                    ...
                    <div class="d flex mb-5">
                            <h6 class="sidebar-col"><span><i class="fa-solid fa-user-pen"></i></span> Ivan Tambunan</h6>
