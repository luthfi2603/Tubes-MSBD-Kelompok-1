...
<div class="container">
    <div class="row mt-4">
        <h5 class="textit mb-4" style="font-weight: 600;"><i class="fa-solid fa-book"></i> Input Kategori</h5>
        ...
        <div class="col-lg-12">
            <div class="inputan-form" style="width: 90%;">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control custom-form" id="tambah-kategori"
